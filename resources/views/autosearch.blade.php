<?php
$file = fopen("autosearch.txt", "r");
$countries = array();
while (!feof($file)) {
    $countries[] = fgets($file);
}
fclose($file);
$URL = "";
?>
                ...
                <ul class="nav nav-pills justify-content-center mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button onClick="return btnClick(this);" class="nav-link" id="allsale" data-bs-toggle="pill"
                                ...
                                aria-selected="false" name="allsale" >بيع
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button onClick="return btnClick(this);" class="nav-link active" id="allrent" data-bs-toggle="pill"
                                data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home"
                                aria-selected="true" name="allrent" >إيجار
                        </button>
                    </li>
                </ul>
            </div>
...
<script>
    ...
    function autocomplete(inp, arr) {
        ...
        inp.addEventListener("input", function(e) {
            ...
            a.setAttribute("style", "background: #f4f4f4;text-align: right;overflow-y: scroll;max-height: 308px;z-index: 0;width: -webkit-fill-available;");
...
<script>
    ...
    function h(){
        document.getElementById("btnClickedValue").value = p;
    }
</script>
